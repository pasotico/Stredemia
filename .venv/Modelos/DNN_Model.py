...
plt.subplot(1, 2, 1)
plt.plot(historia_f.history['loss'], label='Entrenamiento')
plt.plot(historia_f.history['val_loss'], label='Prueba')
plt.title('Pérdida')
plt.xlabel('Época')
plt.ylabel('Loss')
plt.legend()
plt.subplot(1, 2, 2)
plt.plot(historia_f.history['accuracy'], label='Entrenamiento')
plt.plot(historia_f.history['val_accuracy'], label='Prueba')
plt.title('Accuracy')
plt.xlabel('Época')
plt.ylabel('Accuracy')
plt.legend()
