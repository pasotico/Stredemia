...
for i, f1 in enumerate(f1_scores, 1):
    print(f"  Fold {i}: F1-macro = {f1:.4f}")
print(f"  Promedio: {np.mean(f1_scores):.4f}")
...
plt.subplot(1, 2, 1)
plt.plot(historia_final.history['loss'], label='Entrenamiento')
plt.plot(historia_final.history['val_loss'], label='Prueba')
plt.title('Pérdida')
plt.xlabel('Época')
plt.ylabel('Loss')
plt.legend()
plt.subplot(1, 2, 2)
plt.plot(historia_final.history['accuracy'], label='Entrenamiento')
plt.plot(historia_final.history['val_accuracy'], label='Prueba')
plt.title('Accuracy')
plt.xlabel('Época')
plt.ylabel('Accuracy')
plt.legend()
